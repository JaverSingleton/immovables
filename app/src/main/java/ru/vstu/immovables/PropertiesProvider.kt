...
class PropertiesProvider(private val context: Context) {
    ...
    private fun apartment() = listOf(
            ...
            PropertyItem.Select(4, "Количество комнат в квартире", getList(R.array.room_count), isMandatory = true),
            PropertyItem.NumberInput(5, "Этажность дома", ""),
            PropertyItem.NumberInput(6, "Этаж", "", isMandatory = true),
            PropertyItem.NumberInput(7, "Общая площадь квартиры", "", isMandatory = true),
            ...
            PropertyItem.Select(15, "Число санузлов", getList(R.array.bathroom), isMandatory = true),
